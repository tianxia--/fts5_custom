...
import org.sqlite.customsqlitetest.Fts5.FTS5Activity;
import org.sqlite.customsqlitetest.benchmark.BenchmarkActivity;
import org.sqlite.customsqlitetest.sqlcipher.SqlCipherActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void report_version() {
        ...
        appenMsg("SQLite version " + res + "\n\n");
        db.close();
    }

    public void test_warning(String name, String warning) {
        appenMsg("WARNING:" + name + ": " + warning + "\n");
    ...
    */
    ...
    public void sqlCipher(View view) {
        ...
        intent.setClass(this, SqlCipherActivity.class);
